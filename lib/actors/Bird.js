...
import { randInteger, randItem } from '../utils.js';

const VARIANTS = ['f_nyanBalloon', 'f_nyanOriginal', 'f_nyanFloppy']
...
export default class Bird extends Actor {
  constructor (canvasWidth, canvasHeight) {
    ...
    this.variant = randItem(VARIANTS);
    this.sprite = this.variant + this.wingDirection;
    this.birdSpeed = randInteger(5*10,config.settings.birdSpeed*10)/10;
  }
